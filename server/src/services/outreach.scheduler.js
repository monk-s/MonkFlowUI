      ...
      function getFollowupTemplate(touchNumber, lead) {
        ...
        switch (touchNumber) {
          case 2: return {
            ...
            body: `<div style="font-family:sans-serif;max-width:600px;"><p>Hey ${firstName},</p><p>Just floating this back up in case it got buried. Would love to chat if you're open to it.</p><p>Let me know either way — happy to answer any questions.</p><p>Best,<br/>Nathan</p></div>`,
          };
          case 3: return {
            subject: 'Re: Quick question',
            body: `<div style="font-family:sans-serif;max-width:600px;"><p>Hi ${firstName},</p><p>Wanted to share a quick thought — I've been looking at how businesses${company} handle their workflows, and there's usually a lot of room to automate the repetitive stuff.</p><p>If you're curious, I'd be happy to walk through a couple ideas. No pressure at all.</p><p>Cheers,<br/>Nathan</p></div>`,
          };
          case 4: return {
            subject: 'Re: Quick question',
            body: `<div style="font-family:sans-serif;max-width:600px;"><p>Hey ${firstName},</p><p>Totally understand if the timing's off — just didn't want to drop the ball on my end.</p><p>If things change down the road, my door's always open. Wishing you and the team${company} all the best.</p><p>Take care,<br/>Nathan</p></div>`,
          };
          default: return null;
        }
      }
